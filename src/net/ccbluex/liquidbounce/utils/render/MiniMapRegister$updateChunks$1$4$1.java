...
final class MiniMapRegister$updateChunks$1$4$1 implements Function {

    public static final MiniMapRegister$updateChunks$1$4$1 INSTANCE = new MiniMapRegister$updateChunks$1$4$1();

    @NotNull
    public final MiniMapRegister.MiniMapTexture apply(@NotNull MiniMapRegister.ChunkLocation it) {
