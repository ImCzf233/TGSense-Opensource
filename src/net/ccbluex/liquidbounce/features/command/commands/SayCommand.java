...
@Metadata(
    ...
    d2 = { "Lnet/ccbluex/liquidbounce/features/command/commands/SayCommand;", "Lnet/ccbluex/liquidbounce/features/command/Command;", "()V", "execute", "", "args", "", "", "([Ljava/lang/String;)V", "LiquidBounce"}
)
public final class SayCommand extends Command {
    ...
    public void execute(@NotNull String[] args) {
        ...
        if (args.length > 1) {
            ...
            ientityplayersp.sendChatMessage(s);
