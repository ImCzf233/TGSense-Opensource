...
@Metadata(
    ...
    d2 = { "Lnet/ccbluex/liquidbounce/features/command/special/PrivateChatCommand;", "Lnet/ccbluex/liquidbounce/features/command/Command;", "()V", "lChat", "Lnet/ccbluex/liquidbounce/features/module/modules/misc/LiquidChat;", "execute", "", "args", "", "", "([Ljava/lang/String;)V", "LiquidBounce"}
)
public final class PrivateChatCommand extends Command {
    ...
    public PrivateChatCommand() {
        super("pchat", new String[] { "privatechat", "lcpm"});
