...
public final class KillAura2 extends Module {
    ...
    public static final KillAura2.Companion Companion = new KillAura2.Companion((DefaultConstructorMarker) null);
        ...
        Function1 $fun$getColor$4 = new Function1(1) {
            ...
            public final Color invoke(@Nullable IEntityLivingBase ent) {
                ...
                if (ent instanceof EntityLivingBase) {
                    if (StringsKt.equals((String) KillAura2.this.colorModeValue.get(), "Health", true)) {
                        return BlendUtils.getHealthColor(ent.getHealth(), ent.getMaxHealth());
                    }

                    if (((Boolean) KillAura2.this.colorTeam.get()).booleanValue()) {
                ...
                String entityLivingBase = (String) KillAura2.this.colorModeValue.get();
                Color color;
                ...
                case -884013110:
                    if (entityLivingBase.equals("LiquidSlowly")) {
                        color = ColorUtils.LiquidSlowly(System.nanoTime(), 0, ((Number) KillAura2.this.saturationValue.get()).floatValue(), ((Number) KillAura2.this.brightnessValue.get()).floatValue());
                        return color;
                    }
                    break;
                ...
                case 2029746065:
                    if (entityLivingBase.equals("Custom")) {
                        color = new Color(((Number) KillAura2.this.colorRedValue.get()).intValue(), ((Number) KillAura2.this.colorGreenValue.get()).intValue(), ((Number) KillAura2.this.colorBlueValue.get()).intValue());
                        return color;
                    }
                    break;
                ...
                color = ColorUtils.fade(new Color(((Number) KillAura2.this.colorRedValue.get()).intValue(), ((Number) KillAura2.this.colorGreenValue.get()).intValue(), ((Number) KillAura2.this.colorBlueValue.get()).intValue()), 0, 100);
                return color;
            }
        };
        int this_$iv;
        ...
        if (entity1 == null) {
            ...
            case -1221262756:
                if (entity1.equals("health")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura2$updateTarget$$inlined$sortBy$2());
            ...
            case -962590849:
                if (entity1.equals("direction")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura2$updateTarget$$inlined$sortBy$3());
                        CollectionsKt.sortWith(targets, comparator);
                    }
                }
                break;
            ...
            case 288459765:
                if (entity1.equals("distance")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura2$updateTarget$$inlined$sortBy$1(thePlayer));
                        CollectionsKt.sortWith(targets, comparator);
                    }
                }
                break;
            ...
            case 525193846:
                if (entity1.equals("HurtResitanTime")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura2$updateTarget$$inlined$sortBy$5());
                        CollectionsKt.sortWith(targets, comparator);
                    }
                }
                break;
            ...
            case 886905078:
                if (entity1.equals("livingtime")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura2$updateTarget$$inlined$sortBy$4());
                        CollectionsKt.sortWith(targets, comparator);
                    }
                }
            }
            ...
            if (((Boolean) this.raycastValue.get()).booleanValue()) {
                IEntity raycastedEntity1 = RaycastUtils.raycastEntity(reach, (RaycastUtils.EntityFilter) (new RaycastUtils.EntityFilter() {
                    public boolean canRaycast(@Nullable IEntity entity) {
                        ...
                        if (!((Boolean) KillAura2.this.livingRaycastValue.get()).booleanValue() || MinecraftInstance.classProvider.isEntityLivingBase(entity) && !MinecraftInstance.classProvider.isEntityArmorStand(entity)) {
                            label56: {
                                if (!KillAura2.this.isEnemy(entity) && !((Boolean) KillAura2.this.raycastIgnoredValue.get()).booleanValue()) {
                                    if (!((Boolean) KillAura2.this.aacValue.get()).booleanValue()) {
                                        break label56;
                                    }
    ...
    public static final boolean access$isAlive(KillAura2 $this, IEntityLivingBase entity) {
        return $this.isAlive(entity);
    }

    public static final long access$getAttackDelay$p(KillAura2 $this) {
        return $this.attackDelay;
    }

    public static final int getKillCounts() {
        KillAura2.Companion killaura2_companion = KillAura2.Companion;

        return KillAura2.killCounts;
    }

    public static final void setKillCounts(int <set-?>) {
        KillAura2.Companion killaura2_companion = KillAura2.Companion;

        KillAura2.killCounts = <set-?>;
    }
    ...
    @Metadata(
        ...
        k = 1,
        d1 = { "\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R$\u0010\u0003\u001a\u00020\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0014\n\u0000\u0012\u0004\b\u0005\u0010\u0002\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\t¨\u0006\n"},
        d2 = { "Lnet/ccbluex/liquidbounce/features/module/modules/combat/KillAura2$Companion;", "", "()V", "killCounts", "", "killCounts$annotations", "getKillCounts", "()I", "setKillCounts", "(I)V", "LiquidBounce"}
    )
