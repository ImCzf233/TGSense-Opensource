...
public final class KillAura3 extends Module {
    ...
    private final FloatValue maxTurnSpeed = (FloatValue) (new FloatValue("MaxTurnSpeed", 180.0F, 0.0F, 180.0F) {
        protected void onChanged(float oldValue, float newValue) {
            float v = ((Number) KillAura3.this.minTurnSpeed.get()).floatValue();
    ...
    private final FloatValue minTurnSpeed = (FloatValue) (new FloatValue("MinTurnSpeed", 180.0F, 0.0F, 180.0F) {
        protected void onChanged(float oldValue, float newValue) {
            float v = ((Number) KillAura3.this.maxTurnSpeed.get()).floatValue();
    ...
    private final ListValue rotations = new ListValue("RotationMode", new String[] { "None", "LangYaNewHyt", "Liquidbounce", "BackTrack", "Test1", "Test2", "HytRotation"}, "LangYaNewHyt");
    ...
    private final FloatValue maxPredictSize = (FloatValue) (new FloatValue("MaxPredictSize", 1.0F, 0.1F, 5.0F) {
        protected void onChanged(float oldValue, float newValue) {
            float v = ((Number) KillAura3.this.minPredictSize.get()).floatValue();
    ...
    private final FloatValue minPredictSize = (FloatValue) (new FloatValue("MinPredictSize", 1.0F, 0.1F, 5.0F) {
        protected void onChanged(float oldValue, float newValue) {
            float v = ((Number) KillAura3.this.maxPredictSize.get()).floatValue();
    ...
    public static final KillAura3.Companion Companion = new KillAura3.Companion((DefaultConstructorMarker) null);
        ...
        Function1 $fun$getColor$4 = new Function1(1) {
            ...
            public final Color invoke(@Nullable IEntityLivingBase ent) {
                ...
                if (ent instanceof EntityLivingBase) {
                    if (StringsKt.equals((String) KillAura3.this.colorModeValue.get(), "Health", true)) {
                        return BlendUtils.getHealthColor(ent.getHealth(), ent.getMaxHealth());
                    }

                    if (((Boolean) KillAura3.this.colorTeam.get()).booleanValue()) {
                ...
                String entityLivingBase = (String) KillAura3.this.colorModeValue.get();
                Color color;
                ...
                case -884013110:
                    if (entityLivingBase.equals("LiquidSlowly")) {
                        color = ColorUtils.LiquidSlowly(System.nanoTime(), 0, ((Number) KillAura3.this.saturationValue.get()).floatValue(), ((Number) KillAura3.this.brightnessValue.get()).floatValue());
                        return color;
                    }
                    break;
                ...
                case 2029746065:
                    if (entityLivingBase.equals("Custom")) {
                        color = new Color(((Number) KillAura3.this.colorRedValue.get()).intValue(), ((Number) KillAura3.this.colorGreenValue.get()).intValue(), ((Number) KillAura3.this.colorBlueValue.get()).intValue());
                        return color;
                    }
                    break;
                ...
                color = ColorUtils.fade(new Color(((Number) KillAura3.this.colorRedValue.get()).intValue(), ((Number) KillAura3.this.colorGreenValue.get()).intValue(), ((Number) KillAura3.this.colorBlueValue.get()).intValue()), 0, 100);
                return color;
            }
        };
        int this_$iv;
        ...
        if (entity1 == null) {
            ...
            case -1221262756:
                if (entity1.equals("health")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura3$updateTarget$$inlined$sortBy$2());
            ...
            case -962590849:
                if (entity1.equals("direction")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura3$updateTarget$$inlined$sortBy$3());
                        CollectionsKt.sortWith(targets, comparator);
                    }
                }
                break;
            ...
            case 288459765:
                if (entity1.equals("distance")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura3$updateTarget$$inlined$sortBy$1(thePlayer));
                        CollectionsKt.sortWith(targets, comparator);
                    }
                }
                break;
            ...
            case 525193846:
                if (entity1.equals("HurtResitanTime")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura3$updateTarget$$inlined$sortBy$5());
                        CollectionsKt.sortWith(targets, comparator);
                    }
                }
                break;
            ...
            case 886905078:
                if (entity1.equals("livingtime")) {
                    ...
                    if (targets.size() > 1) {
                        entityFov1 = false;
                        comparator = (Comparator) (new KillAura3$updateTarget$$inlined$sortBy$4());
                        CollectionsKt.sortWith(targets, comparator);
                    }
                }
            }
        ...
        if (StringsKt.equals((String) this.rotations.get(), "test1", true)) {
            if (((Number) this.maxTurnSpeed.get()).floatValue() <= 0.0F) {
                ...
                if (vecrotation != null) {
                    ...
                    limitedRotation2 = limitedRotation1.component1();
                    rotation1 = limitedRotation1.component2();
            ...
            if (StringsKt.equals((String) this.rotations.get(), "HytRotation", true)) {
                ...
                if (vecrotation != null) {
                    ...
                    limitedRotation = rotation.component2();
                    rotation = RotationUtils.limitAngleChange(RotationUtils.serverRotation, limitedRotation, (float) (Math.random() * (double) (((Number) this.maxTurnSpeed.get()).floatValue() - ((Number) this.minTurnSpeed.get()).floatValue()) + ((Number) this.minTurnSpeed.get()).doubleValue()));
                    Intrinsics.checkExpressionValueIsNotNull(rotation, "RotationUtils.limitAngle…rnSpeed.get()).toFloat())");
                    rotation1 = rotation;
                    if (((Boolean) this.silentRotationValue.get()).booleanValue()) {
                        RotationUtils.setTargetRotation(rotation1, ((Boolean) this.aacValue.get()).booleanValue() ? 15 : 0);
                    } else {
                        ientityplayersp = MinecraftInstance.mc.getThePlayer();
                        if (ientityplayersp == null) {
                            Intrinsics.throwNpe();
                        ...
                        rotation1.toPlayer((IEntityPlayer) ientityplayersp);
                    }
                ...
                if (StringsKt.equals((String) this.rotations.get(), "LangYaNewHyt", true)) {
                    if (((Boolean) this.predictValue.get()).booleanValue()) {
                        boundingBox = boundingBox.offset((entity.getPosX() - entity.getPrevPosX()) * (double) RandomUtils.INSTANCE.nextFloat(((Number) this.minPredictSize.get()).floatValue(), ((Number) this.maxPredictSize.get()).floatValue()), (entity.getPosY() - entity.getPrevPosY()) * (double) RandomUtils.INSTANCE.nextFloat(((Number) this.minPredictSize.get()).floatValue(), ((Number) this.maxPredictSize.get()).floatValue()), (entity.getPosZ() - entity.getPrevPosZ()) * (double) RandomUtils.INSTANCE.nextFloat(((Number) this.minPredictSize.get()).floatValue(), ((Number) this.maxPredictSize.get()).floatValue()));
                    }
                    ...
                    limitedRotation = rotation.component2();
                    rotation = RotationUtils.limitAngleChange(RotationUtils.serverRotation, limitedRotation, (float) (Math.random() * (double) (((Number) this.maxTurnSpeed.get()).floatValue() - ((Number) this.minTurnSpeed.get()).floatValue()) + ((Number) this.minTurnSpeed.get()).doubleValue()));
                    Intrinsics.checkExpressionValueIsNotNull(rotation, "RotationUtils.limitAngle�?).toFloat()\n            )");
                    rotation1 = rotation;
                    if (!((Boolean) this.silentRotationValue.get()).booleanValue()) {
                        ientityplayersp = MinecraftInstance.mc.getThePlayer();
                        if (ientityplayersp == null) {
                ...
                if (!StringsKt.equals((String) this.rotations.get(), "LiquidBounce", true)) {
                    if (StringsKt.equals((String) this.rotations.get(), "BackTrack", true)) {
                        ...
                        if (!((Boolean) this.silentRotationValue.get()).booleanValue()) {
                            ...
                            limitedRotation.toPlayer((IEntityPlayer) ientityplayersp);
                            return true;
                        }

                        RotationUtils.setTargetRotation(limitedRotation, ((Boolean) this.aacValue.get()).booleanValue() ? 15 : 0);
                    }
                    ...
                    if (vecrotation != null) {
                        ...
                        limitedRotation2 = limitedRotation1.component1();
                        rotation1 = limitedRotation1.component2();
                        rotation = RotationUtils.limitAngleChange(RotationUtils.serverRotation, rotation1, (float) (Math.random() * (double) (((Number) this.maxTurnSpeed.get()).floatValue() - ((Number) this.minTurnSpeed.get()).floatValue()) + ((Number) this.minTurnSpeed.get()).doubleValue()));
                        Intrinsics.checkExpressionValueIsNotNull(rotation, "RotationUtils.limitAngle…rnSpeed.get()).toFloat())");
                        limitedRotation3 = rotation;
                        if (((Boolean) this.silentRotationValue.get()).booleanValue()) {
                            RotationUtils.setTargetRotation(limitedRotation3, ((Boolean) this.aacValue.get()).booleanValue() ? 15 : 0);
            ...
            if (((Boolean) this.raycastValue.get()).booleanValue()) {
                IEntity raycastedEntity1 = RaycastUtils.raycastEntity(reach, (RaycastUtils.EntityFilter) (new RaycastUtils.EntityFilter() {
                    public boolean canRaycast(@Nullable IEntity entity) {
                        ...
                        if (!((Boolean) KillAura3.this.livingRaycastValue.get()).booleanValue() || MinecraftInstance.classProvider.isEntityLivingBase(entity) && !MinecraftInstance.classProvider.isEntityArmorStand(entity)) {
                            label56: {
                                if (!KillAura3.this.isEnemy(entity) && !((Boolean) KillAura3.this.raycastIgnoredValue.get()).booleanValue()) {
                                    if (!((Boolean) KillAura3.this.aacValue.get()).booleanValue()) {
                                        break label56;
                                    }
    ...
    public static final boolean access$isAlive(KillAura3 $this, IEntityLivingBase entity) {
    ...
    public static final int getKillCounts() {
        KillAura3.Companion killaura3_companion = KillAura3.Companion;

        return KillAura3.killCounts;
    }

    public static final void setKillCounts(int <set-?>) {
        KillAura3.Companion killaura3_companion = KillAura3.Companion;

        KillAura3.killCounts = <set-?>;
    }
    ...
    @Metadata(
        ...
        k = 1,
        d1 = { "\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R$\u0010\u0003\u001a\u00020\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0014\n\u0000\u0012\u0004\b\u0005\u0010\u0002\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\t¨\u0006\n"},
        d2 = { "Lnet/ccbluex/liquidbounce/features/module/modules/combat/KillAura3$Companion;", "", "()V", "killCounts", "", "killCounts$annotations", "getKillCounts", "()I", "setKillCounts", "(I)V", "LiquidBounce"}
    )
