...
public final class KillAura4$updateTarget$$inlined$sortBy$1 implements Comparator {

    final IEntityPlayerSP $thePlayer$inlined;

    public KillAura4$updateTarget$$inlined$sortBy$1(IEntityPlayerSP ientityplayersp) {
    ...
    public final int compare(Object a, Object b) {
        ...
        boolean $i$a$-sortBy-KillAura4$updateTarget$1 = false;
        ...
        $i$a$-sortBy-KillAura4$updateTarget$1 = false;
