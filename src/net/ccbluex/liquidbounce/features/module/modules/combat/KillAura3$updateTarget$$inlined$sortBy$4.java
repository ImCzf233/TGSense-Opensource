...
public final class KillAura3$updateTarget$$inlined$sortBy$4 implements Comparator {

    public final int compare(Object a, Object b) {
        boolean flag = false;
        IEntityLivingBase it = (IEntityLivingBase) a;
        boolean $i$a$-sortBy-KillAura3$updateTarget$4 = false;
        Comparable comparable = (Comparable) Integer.valueOf(-it.getTicksExisted());

        it = (IEntityLivingBase) b;
        Comparable comparable1 = comparable;

        $i$a$-sortBy-KillAura3$updateTarget$4 = false;
        Integer integer = Integer.valueOf(-it.getTicksExisted());
