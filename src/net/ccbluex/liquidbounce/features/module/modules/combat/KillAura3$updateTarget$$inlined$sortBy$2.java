...
public final class KillAura3$updateTarget$$inlined$sortBy$2 implements Comparator {

    public final int compare(Object a, Object b) {
        boolean flag = false;
        IEntityLivingBase it = (IEntityLivingBase) a;
        boolean $i$a$-sortBy-KillAura3$updateTarget$2 = false;
        Comparable comparable = (Comparable) Float.valueOf(it.getHealth());

        it = (IEntityLivingBase) b;
        Comparable comparable1 = comparable;

        $i$a$-sortBy-KillAura3$updateTarget$2 = false;
        Float ofloat = Float.valueOf(it.getHealth());
