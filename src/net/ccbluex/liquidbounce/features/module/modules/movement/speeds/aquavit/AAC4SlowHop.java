...
@Metadata(
    ...
    d2 = { "Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/aquavit/AAC4SlowHop;", "Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/SpeedMode;", "()V", "onDisable", "", "onEnable", "onMotion", "event", "Lnet/ccbluex/liquidbounce/event/MotionEvent;", "onMove", "Lnet/ccbluex/liquidbounce/event/MoveEvent;", "onTick", "onUpdate", "LiquidBounce"}
)
        ...
        if (!ientityplayersp.isInWater()) {
            if (MovementUtils.isMoving()) {
                ...
                if (!ientityplayersp.getOnGround()) {
                    ...
                    if ((double) ientityplayersp.getFallDistance() <= 0.1D) {
                        ientityplayersp = MinecraftInstance.mc.getThePlayer();
                        if (ientityplayersp == null) {
                            Intrinsics.throwNpe();
                        }
                ...
                if ((double) ientityplayersp.getFallDistance() > 0.1D) {
                    ...
                    if ((double) ientityplayersp.getFallDistance() < 1.3D) {
                        ientityplayersp = MinecraftInstance.mc.getThePlayer();
                        if (ientityplayersp == null) {
                            Intrinsics.throwNpe();
                        }

                        ientityplayersp.setSpeedInAir(0.0205F);
