...
@Metadata(
    ...
    d2 = { "Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/aquavit/AAC4Hop;", "Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/SpeedMode;", "()V", "onDisable", "", "onEnable", "onMotion", "event", "Lnet/ccbluex/liquidbounce/event/MotionEvent;", "onMove", "Lnet/ccbluex/liquidbounce/event/MoveEvent;", "onTick", "onUpdate", "LiquidBounce"}
)
        ...
        if (!ientityplayersp.isInWater()) {
            if (MovementUtils.isMoving()) {
                ...
                if (ientityplayersp.getOnGround()) {
                    ...
                    ientityplayersp.setSpeedInAir(0.0201F);
                ...
                if ((double) ientityplayersp.getFallDistance() > 0.7D) {
                    ientityplayersp = MinecraftInstance.mc.getThePlayer();
                    if (ientityplayersp == null) {
                        Intrinsics.throwNpe();
                    }
