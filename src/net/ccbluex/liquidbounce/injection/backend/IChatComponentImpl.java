...
public final class IChatComponentImpl implements IIChatComponent {
    ...
    public String getUnformattedText() {
        String s = this.wrapped.getUnformattedText();

        Intrinsics.checkExpressionValueIsNotNull(s, "wrapped.unformattedText");
        return s;
    }

    @NotNull
    public IChatStyle getChatStyle() {
        Style style = this.wrapped.getStyle();

        Intrinsics.checkExpressionValueIsNotNull(style, "wrapped.style");
        Style $this$wrap$iv = style;
        boolean $i$f$wrap = false;

        return (IChatStyle) (new ChatStyleImpl($this$wrap$iv));
    }

    @NotNull
    public String getFormattedText() {
        String s = this.wrapped.getFormattedText();

        Intrinsics.checkExpressionValueIsNotNull(s, "wrapped.formattedText");
        return s;
    }

    public void appendText(@NotNull String text) {
        Intrinsics.checkParameterIsNotNull(text, "text");
        this.wrapped.appendText(text);
    }
    ...
    public void appendSibling(@NotNull IIChatComponent component) {
        ...
        ITextComponent itextcomponent1 = ((IChatComponentImpl) component).getWrapped();
