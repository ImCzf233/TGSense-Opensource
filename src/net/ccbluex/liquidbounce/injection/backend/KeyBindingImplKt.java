...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/client/settings/KeyBinding;", "Lnet/ccbluex/liquidbounce/api/minecraft/client/settings/IKeyBinding;", "wrap", "LiquidBounce"}
)
public final class KeyBindingImplKt {
    ...
    public static final IKeyBinding wrap(@NotNull KeyBinding $this$wrap) {
        ...
        return (IKeyBinding) (new KeyBindingImpl($this$wrap));
    }
}
