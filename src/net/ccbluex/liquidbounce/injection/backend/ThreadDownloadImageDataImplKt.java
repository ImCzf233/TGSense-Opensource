...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/client/renderer/ThreadDownloadImageData;", "Lnet/ccbluex/liquidbounce/api/minecraft/client/render/IThreadDownloadImageData;", "wrap", "LiquidBounce"}
)
public final class ThreadDownloadImageDataImplKt {
    ...
    public static final IThreadDownloadImageData wrap(@NotNull ThreadDownloadImageData $this$wrap) {
        ...
        return (IThreadDownloadImageData) (new ThreadDownloadImageDataImpl($this$wrap));
    }
}
