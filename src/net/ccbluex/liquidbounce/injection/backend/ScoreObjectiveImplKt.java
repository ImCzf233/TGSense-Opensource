...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/scoreboard/ScoreObjective;", "Lnet/ccbluex/liquidbounce/api/minecraft/scoreboard/IScoreObjective;", "wrap", "LiquidBounce"}
)
public final class ScoreObjectiveImplKt {
    ...
    public static final IScoreObjective wrap(@NotNull ScoreObjective $this$wrap) {
        ...
        return (IScoreObjective) (new ScoreObjectiveImpl($this$wrap));
    }
}
