...
public final class BackendExtentionsKt$WhenMappings {
    ...
    static {
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$0[Type.MISS.ordinal()] = 1;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$0[Type.BLOCK.ordinal()] = 2;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$0[Type.ENTITY.ordinal()] = 3;
        ...
        $EnumSwitchMapping$7 = new int[Action.values().length];
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$7[Action.INTERACT.ordinal()] = 1;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$7[Action.ATTACK.ordinal()] = 2;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$7[Action.INTERACT_AT.ordinal()] = 3;
        ...
        $EnumSwitchMapping$9 = new int[net.minecraft.network.play.client.CPacketPlayerDigging.Action.values().length];
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$9[net.minecraft.network.play.client.CPacketPlayerDigging.Action.ABORT_DESTROY_BLOCK.ordinal()] = 1;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$9[net.minecraft.network.play.client.CPacketPlayerDigging.Action.DROP_ALL_ITEMS.ordinal()] = 2;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$9[net.minecraft.network.play.client.CPacketPlayerDigging.Action.DROP_ITEM.ordinal()] = 3;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$9[net.minecraft.network.play.client.CPacketPlayerDigging.Action.RELEASE_USE_ITEM.ordinal()] = 4;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$9[net.minecraft.network.play.client.CPacketPlayerDigging.Action.START_DESTROY_BLOCK.ordinal()] = 5;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$9[net.minecraft.network.play.client.CPacketPlayerDigging.Action.STOP_DESTROY_BLOCK.ordinal()] = 6;
        BackendExtentionsKt$WhenMappings.$EnumSwitchMapping$9[net.minecraft.network.play.client.CPacketPlayerDigging.Action.SWAP_HELD_ITEMS.ordinal()] = 7;
