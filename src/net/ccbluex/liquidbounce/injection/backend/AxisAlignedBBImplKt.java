...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/util/math/AxisAlignedBB;", "Lnet/ccbluex/liquidbounce/api/minecraft/util/IAxisAlignedBB;", "wrap", "LiquidBounce"}
)
public final class AxisAlignedBBImplKt {
    ...
    public static final IAxisAlignedBB wrap(@NotNull AxisAlignedBB $this$wrap) {
        ...
        return (IAxisAlignedBB) (new AxisAlignedBBImpl($this$wrap));
    }
}
