...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/client/gui/inventory/GuiChest;", "Lnet/ccbluex/liquidbounce/api/minecraft/client/gui/inventory/IGuiChest;", "wrap", "LiquidBounce"}
)
public final class GuiChestImplKt {
    ...
    public static final IGuiChest wrap(@NotNull GuiChest $this$wrap) {
        ...
        return (IGuiChest) (new GuiChestImpl($this$wrap));
    }
}
