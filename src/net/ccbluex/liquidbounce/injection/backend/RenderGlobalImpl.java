...
public final class RenderGlobalImpl implements IRenderGlobal {
    ...
    public void loadRenderers() {
        this.wrapped.loadRenderers();
    }

    public boolean equals(@Nullable Object other) {
        return other instanceof RenderGlobalImpl && Intrinsics.areEqual(((RenderGlobalImpl) other).wrapped, this.wrapped);
    }
