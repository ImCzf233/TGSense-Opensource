...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/client/gui/inventory/GuiContainer;", "Lnet/ccbluex/liquidbounce/api/minecraft/client/gui/inventory/IGuiContainer;", "wrap", "LiquidBounce"}
)
public final class GuiContainerImplKt {
    ...
    public static final IGuiContainer wrap(@NotNull GuiContainer $this$wrap) {
        ...
        return (IGuiContainer) (new GuiContainerImpl($this$wrap));
    }
}
