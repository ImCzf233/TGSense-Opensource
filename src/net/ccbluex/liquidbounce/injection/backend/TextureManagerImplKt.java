...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/client/renderer/texture/TextureManager;", "Lnet/ccbluex/liquidbounce/api/minecraft/client/render/texture/ITextureManager;", "wrap", "LiquidBounce"}
)
public final class TextureManagerImplKt {
    ...
    public static final ITextureManager wrap(@NotNull TextureManager $this$wrap) {
        ...
        return (ITextureManager) (new TextureManagerImpl($this$wrap));
    }
}
