...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/client/shader/Framebuffer;", "Lnet/ccbluex/liquidbounce/api/minecraft/client/shader/IFramebuffer;", "wrap", "LiquidBounce"}
)
public final class FramebufferImplKt {
    ...
    public static final IFramebuffer wrap(@NotNull Framebuffer $this$wrap) {
        ...
        return (IFramebuffer) (new FramebufferImpl($this$wrap));
    }
}
