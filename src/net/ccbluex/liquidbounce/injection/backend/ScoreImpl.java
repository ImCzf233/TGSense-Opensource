...
public final class ScoreImpl implements IScore {
    ...
    public int getScorePoints() {
        return this.wrapped.getScorePoints();
    }

    @NotNull
    public String getPlayerName() {
        String s = this.wrapped.getPlayerName();

        Intrinsics.checkExpressionValueIsNotNull(s, "wrapped.playerName");
        return s;
    }

    public boolean equals(@Nullable Object other) {
        return other instanceof ScoreImpl && Intrinsics.areEqual(((ScoreImpl) other).wrapped, this.wrapped);
    }
