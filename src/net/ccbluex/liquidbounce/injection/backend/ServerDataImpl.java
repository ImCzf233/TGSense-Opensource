...
public final class ServerDataImpl implements IServerData {
    ...
    public long getPingToServer() {
        return this.wrapped.pingToServer;
    }
    ...
    public String getGameVersion() {
        String s = this.wrapped.gameVersion;

        Intrinsics.checkExpressionValueIsNotNull(this.wrapped.gameVersion, "wrapped.gameVersion");
        return s;
    }

    @NotNull
    public String getServerMOTD() {
        String s = this.wrapped.serverMOTD;

        Intrinsics.checkExpressionValueIsNotNull(this.wrapped.serverMOTD, "wrapped.serverMOTD");
        return s;
    }

    @NotNull
    public String getPopulationInfo() {
        String s = this.wrapped.populationInfo;

        Intrinsics.checkExpressionValueIsNotNull(this.wrapped.populationInfo, "wrapped.populationInfo");
        return s;
    }

    @NotNull
    public String getServerName() {
        String s = this.wrapped.serverName;

        Intrinsics.checkExpressionValueIsNotNull(this.wrapped.serverName, "wrapped.serverName");
        return s;
    }

    @NotNull
    public String getServerIP() {
        String s = this.wrapped.serverIP;

        Intrinsics.checkExpressionValueIsNotNull(this.wrapped.serverIP, "wrapped.serverIP");
        return s;
    }

    public boolean equals(@Nullable Object other) {
        return other instanceof ServerDataImpl && Intrinsics.areEqual(((ServerDataImpl) other).wrapped, this.wrapped);
    }
