...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/network/play/client/CPacketCloseWindow;", "Lnet/ccbluex/liquidbounce/api/minecraft/network/play/client/ICPacketCloseWindow;", "wrap", "LiquidBounce"}
)
public final class CPacketCloseWindowImplKt {
    ...
    public static final ICPacketCloseWindow wrap(@NotNull CPacketCloseWindow $this$wrap) {
        ...
        return (ICPacketCloseWindow) (new CPacketCloseWindowImpl($this$wrap));
    }
}
