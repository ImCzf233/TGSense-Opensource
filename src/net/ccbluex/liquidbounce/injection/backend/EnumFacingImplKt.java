...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/util/EnumFacing;", "Lnet/ccbluex/liquidbounce/api/minecraft/util/IEnumFacing;", "wrap", "LiquidBounce"}
)
public final class EnumFacingImplKt {
    ...
    public static final IEnumFacing wrap(@NotNull EnumFacing $this$wrap) {
        ...
        return (IEnumFacing) (new EnumFacingImpl($this$wrap));
    }
}
