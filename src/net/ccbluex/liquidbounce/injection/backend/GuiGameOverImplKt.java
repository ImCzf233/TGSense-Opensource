...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/client/gui/GuiGameOver;", "Lnet/ccbluex/liquidbounce/api/minecraft/client/gui/IGuiGameOver;", "wrap", "LiquidBounce"}
)
public final class GuiGameOverImplKt {
    ...
    public static final IGuiGameOver wrap(@NotNull GuiGameOver $this$wrap) {
        ...
        return (IGuiGameOver) (new GuiGameOverImpl($this$wrap));
    }
}
