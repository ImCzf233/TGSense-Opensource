...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/entity/player/InventoryPlayer;", "Lnet/ccbluex/liquidbounce/api/minecraft/entity/player/IInventoryPlayer;", "wrap", "LiquidBounce"}
)
public final class InventoryPlayerImplKt {
    ...
    public static final IInventoryPlayer wrap(@NotNull InventoryPlayer $this$wrap) {
        ...
        return (IInventoryPlayer) (new InventoryPlayerImpl($this$wrap));
    }
}
