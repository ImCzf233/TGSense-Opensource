...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/network/play/server/SPacketResourcePackSend;", "Lnet/ccbluex/liquidbounce/api/minecraft/network/play/server/ISPacketResourcePackSend;", "wrap", "LiquidBounce"}
)
public final class SPacketResourcePackSendImplKt {
    ...
    public static final ISPacketResourcePackSend wrap(@NotNull SPacketResourcePackSend $this$wrap) {
        ...
        return (ISPacketResourcePackSend) (new SPacketResourcePackSendImpl($this$wrap));
    }
}
