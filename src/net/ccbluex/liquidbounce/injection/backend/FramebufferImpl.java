...
public final class FramebufferImpl implements IFramebuffer {
    ...
    public void bindFramebuffer(boolean b) {
        this.wrapped.bindFramebuffer(b);
    }

    public boolean equals(@Nullable Object other) {
        return other instanceof FramebufferImpl && Intrinsics.areEqual(((FramebufferImpl) other).wrapped, this.wrapped);
    }
