...
public final class MovementInputImpl implements IMovementInput {
    ...
    public float getMoveStrafe() {
        return this.wrapped.moveStrafe;
    }

    public boolean getJump() {
        return this.wrapped.jump;
    }

    public boolean equals(@Nullable Object other) {
        return other instanceof MovementInputImpl && Intrinsics.areEqual(((MovementInputImpl) other).wrapped, this.wrapped);
    }
