...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/network/play/client/CPacketChatMessage;", "Lnet/ccbluex/liquidbounce/api/minecraft/network/play/client/ICPacketChatMessage;", "wrap", "LiquidBounce"}
)
public final class CPacketChatMessageImplKt {
    ...
    public static final ICPacketChatMessage wrap(@NotNull CPacketChatMessage $this$wrap) {
        ...
        return (ICPacketChatMessage) (new CPacketChatMessageImpl($this$wrap));
    }
}
