...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/potion/PotionEffect;", "Lnet/ccbluex/liquidbounce/api/minecraft/potion/IPotionEffect;", "wrap", "LiquidBounce"}
)
public final class PotionEffectImplKt {
    ...
    public static final IPotionEffect wrap(@NotNull PotionEffect $this$wrap) {
        ...
        return (IPotionEffect) (new PotionEffectImpl($this$wrap));
    }
}
