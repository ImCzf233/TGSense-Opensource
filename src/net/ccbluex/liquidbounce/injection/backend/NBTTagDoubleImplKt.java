...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/nbt/NBTTagDouble;", "Lnet/ccbluex/liquidbounce/api/minecraft/nbt/INBTTagDouble;", "wrap", "LiquidBounce"}
)
public final class NBTTagDoubleImplKt {
    ...
    public static final INBTTagDouble wrap(@NotNull NBTTagDouble $this$wrap) {
        ...
        return (INBTTagDouble) (new NBTTagDoubleImpl($this$wrap));
    }
}
