...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/creativetab/CreativeTabs;", "Lnet/ccbluex/liquidbounce/api/minecraft/creativetabs/ICreativeTabs;", "wrap", "LiquidBounce"}
)
public final class CreativeTabsImplKt {
    ...
    public static final ICreativeTabs wrap(@NotNull CreativeTabs $this$wrap) {
        ...
        return (ICreativeTabs) (new CreativeTabsImpl($this$wrap));
    }
}
