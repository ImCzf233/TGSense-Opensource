...
public final class IBlockStateImpl implements IIBlockState {
    ...
    public IBlock getBlock() {
        Block block = this.wrapped.getBlock();
    ...
    public boolean equals(@Nullable Object other) {
        return other instanceof IBlockStateImpl && Intrinsics.areEqual(((IBlockStateImpl) other).wrapped, this.wrapped);
    }
