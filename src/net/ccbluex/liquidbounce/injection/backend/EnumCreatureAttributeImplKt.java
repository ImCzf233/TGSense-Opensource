...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/entity/EnumCreatureAttribute;", "Lnet/ccbluex/liquidbounce/api/minecraft/entity/IEnumCreatureAttribute;", "wrap", "LiquidBounce"}
)
public final class EnumCreatureAttributeImplKt {
    ...
    public static final IEnumCreatureAttribute wrap(@NotNull EnumCreatureAttribute $this$wrap) {
        ...
        return (IEnumCreatureAttribute) (new EnumCreatureAttributeImpl($this$wrap));
    }
}
