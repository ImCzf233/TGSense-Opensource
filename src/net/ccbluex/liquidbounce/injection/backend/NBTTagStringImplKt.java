...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/nbt/NBTTagString;", "Lnet/ccbluex/liquidbounce/api/minecraft/nbt/INBTTagString;", "wrap", "LiquidBounce"}
)
public final class NBTTagStringImplKt {
    ...
    public static final INBTTagString wrap(@NotNull NBTTagString $this$wrap) {
        ...
        return (INBTTagString) (new NBTTagStringImpl($this$wrap));
    }
}
