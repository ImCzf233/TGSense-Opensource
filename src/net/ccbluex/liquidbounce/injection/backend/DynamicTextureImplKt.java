...
@Metadata(
    ...
    d2 = { "unwrap", "Lnet/minecraft/client/renderer/texture/DynamicTexture;", "Lnet/ccbluex/liquidbounce/api/minecraft/client/render/texture/IDynamicTexture;", "wrap", "LiquidBounce"}
)
public final class DynamicTextureImplKt {
    ...
    public static final IDynamicTexture wrap(@NotNull DynamicTexture $this$wrap) {
        ...
        return (IDynamicTexture) (new DynamicTextureImpl($this$wrap));
    }
}
