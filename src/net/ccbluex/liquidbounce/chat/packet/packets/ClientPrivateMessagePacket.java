...
public final class ClientPrivateMessagePacket implements Packet {
    ...
    public static ClientPrivateMessagePacket copy$default(ClientPrivateMessagePacket clientprivatemessagepacket, String s, User user, String s1, int i, Object object) {
        if ((i & 1) != 0) {
            s = clientprivatemessagepacket.id;
        }
        ...
        if ((i & 4) != 0) {
            s1 = clientprivatemessagepacket.content;
        }

        return clientprivatemessagepacket.copy(s, user, s1);
    }
    ...
    public boolean equals(@Nullable Object object) {
        if (this != object) {
            if (object instanceof ClientPrivateMessagePacket) {
                ClientPrivateMessagePacket clientprivatemessagepacket = (ClientPrivateMessagePacket) object;

                if (Intrinsics.areEqual(this.id, clientprivatemessagepacket.id) && Intrinsics.areEqual(this.user, clientprivatemessagepacket.user) && Intrinsics.areEqual(this.content, clientprivatemessagepacket.content)) {
                    return true;
                }
            }
