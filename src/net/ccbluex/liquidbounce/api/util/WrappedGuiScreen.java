...
public abstract class WrappedGuiScreen extends MinecraftInstance {
    ...
    public final IGuiScreen getRepresentedScreen() {
        ...
        if (this.representedScreen == null) {
    ...
    public final void setRepresentedScreen(@NotNull IGuiScreen <set-?>) {
        Intrinsics.checkParameterIsNotNull(<set-?>, "<set-?>");
        this.representedScreen = <set-?>;
    }
