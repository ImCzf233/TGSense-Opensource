...
@Metadata(
    ...
    d2 = { "Lnet/ccbluex/liquidbounce/api/minecraft/client/network/IINetHandlerPlayClient;", "", "networkManager", "Lnet/ccbluex/liquidbounce/api/minecraft/INetworkManager;", "getNetworkManager", "()Lnet/ccbluex/liquidbounce/api/minecraft/INetworkManager;", "playerInfoMap", "", "Lnet/ccbluex/liquidbounce/api/minecraft/client/network/INetworkPlayerInfo;", "getPlayerInfoMap", "()Ljava/util/Collection;", "addToSendQueue", "", "classProviderCPacketHeldItemChange", "Lnet/ccbluex/liquidbounce/api/minecraft/network/IPacket;", "getPlayerInfo", "uuid", "Ljava/util/UUID;", "LiquidBounce"}
)
