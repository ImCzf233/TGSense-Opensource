...
@Metadata(
    ...
    d2 = { "Lnet/ccbluex/liquidbounce/api/minecraft/util/WMathHelper;", "", "()V", "clamp_double", "", "num", "min", "max", "clamp_float", "", "floor_double", "", "value", "wrapAngleTo180_float", "angle", "LiquidBounce"}
)
public final class WMathHelper {
    ...
    static {
        WMathHelper wmathhelper = new WMathHelper();

        INSTANCE = wmathhelper;
    }
}
