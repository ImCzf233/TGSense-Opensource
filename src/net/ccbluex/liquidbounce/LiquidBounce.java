...
public final class LiquidBounce {
    ...
    @NotNull
    public static final String CLIENT_VERSION = "230110";
    @NotNull
    ...
    public final void startClient() {
        ...
        Display.setTitle("TGSense B1 | Dev:LangYa,Happy | Kill You Mon Aura ");
        ClientUtils.getLogger().info("Starting TGSense b230110, by ");
