...
public final class HUD$render$$inlined$sortedBy$1 implements Comparator {

    public final int compare(Object a, Object b) {
        boolean flag = false;
        Element it = (Element) a;
        boolean $i$a$-sortedBy-HUD$render$1 = false;
        Comparable comparable = (Comparable) Integer.valueOf(-it.getInfo().priority());

        it = (Element) b;
        Comparable comparable1 = comparable;

        $i$a$-sortedBy-HUD$render$1 = false;
        Integer integer = Integer.valueOf(-it.getInfo().priority());
