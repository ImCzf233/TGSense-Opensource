...
public final class Arraylist extends Element {
    ...
    public Border drawElement() {
        ...
        while ($i$f$forEachIndexed.hasNext()) {
            ...
            if (module.getArray() && module.getSlide() > 0.0F) {
                ...
                label431: {
                    label430: {
                        ...
                        case -1275652174:
                            if (item$iv.equals("LiquidSense")) {
                                if (module.getState()) {
                                    if (module.getArrayY() < f) {
                                        module.setArrayY(module.getArrayY() + (f1 - Math.min(module.getArrayY() * 0.002F, f1 - module.getArrayY() * 1.0E-4F)) * (float) delta);
                                        module.setArrayY(Math.min(f, module.getArrayY()));
                                    } else {
                                        module.setArrayY(module.getArrayY() - (f1 - Math.min(module.getArrayY() * 0.002F, f1 - module.getArrayY() * 1.0E-4F)) * (float) delta);
                                        module.setArrayY(Math.max(module.getArrayY(), f));
                                    }
                                }
                                break label431;
                            }
                        ...
                        case 961091784:
                            if (item$iv.equals("Astolfo")) {
                                if (module.getArrayY() < f) {
                                    module.setArrayY(module.getArrayY() + ((Number) this.animationSpeed.get()).floatValue() / 2.0F * (float) delta);
                                    module.setArrayY(Math.min(f, module.getArrayY()));
                                } else {
                                    module.setArrayY(module.getArrayY() - ((Number) this.animationSpeed.get()).floatValue() / 2.0F * (float) delta);
                                    module.setArrayY(Math.max(module.getArrayY(), f));
                    ...
                    module.setArrayY((float) AnimationUtils.animate((double) f, (double) module.getArrayY(), (double) ((Number) this.animationSpeed.get()).floatValue() * 0.025D * (double) delta));
                }
        ...
        Object module1;
        int index;
        boolean $i$a$-forEachIndexed-Arraylist$drawElement$10;
        ...
        case 2:
            if (((Boolean) this.shadowShaderValue.get()).booleanValue()) {
                ...
                ShadowUtils.INSTANCE.shadow((float) ((Number) this.shadowStrength.get()).intValue(), (Function0) (new Function0(0) {
                    public final void invoke() {
                        ...
                        Iterable $this$forEachIndexed$iv = (Iterable) Arraylist.this.modules;
                        ...
                        for (Iterator iterator = $this$forEachIndexed$iv.iterator(); iterator.hasNext(); RenderUtils.newDrawRect(f3, f2, f1, f, i)) {
                            ...
                            boolean $i$a$-forEachIndexed-Arraylist$drawElement$1$1 = false;
                            float xPos = -module.getSlide() - (float) 2;
                            float f4 = xPos - (float) (StringsKt.equals((String) Arraylist.this.rectRightValue.get(), "right", true) ? 3 : 2);
                            float f5 = module.getHigt();
                            float f6 = StringsKt.equals((String) Arraylist.this.rectRightValue.get(), "right", true) ? -1.0F : 0.0F;
                            float f7 = module.getHigt() + textHeight;
                            String s = (String) Arraylist.this.shadowColorMode.get();
                            ...
                            case -1332194002:
                                if (s2.equals("background")) {
                                    i = (new Color(((Number) Arraylist.this.backgroundColorRedValue.get()).intValue(), ((Number) Arraylist.this.backgroundColorGreenValue.get()).intValue(), ((Number) Arraylist.this.backgroundColorBlueValue.get()).intValue())).getRGB();
                                    continue;
                                }
                                break;
                            ...
                            case 3556653:
                                if (s2.equals("text")) {
                                    ...
                                    int k = color.getRGB();
                                    int Sky = RenderUtils.SkyRainbow(counter[0] * ((Number) Arraylist.this.skyDistanceValue.get()).intValue() * 50, ((Number) Arraylist.this.saturationValue.get()).floatValue(), ((Number) Arraylist.this.brightnessValue.get()).floatValue());
                                    int CRainbow = RenderUtils.getRainbowOpaque(((Number) Arraylist.this.cRainbowSecValue.get()).intValue(), ((Number) Arraylist.this.saturationValue.get()).floatValue(), ((Number) Arraylist.this.brightnessValue.get()).floatValue(), counter[0] * 50 * ((Number) Arraylist.this.cRainbowDistValue.get()).intValue());
                                    int FadeColor = ColorUtils.fade(new Color(((Number) Arraylist.this.getColorRedValue().get()).intValue(), ((Number) Arraylist.this.getColorGreenValue().get()).intValue(), ((Number) Arraylist.this.getColorBlueValue().get()).intValue(), ((Number) Arraylist.this.getColorAlphaValue().get()).intValue()), j * ((Number) Arraylist.this.fadeDistanceValue.get()).intValue(), 100).getRGB();
                                    boolean color3 = false;

                                    color = RenderUtils.getGradientOffset(new Color(((Number) Arraylist.this.textRed.get()).intValue(), ((Number) Arraylist.this.textGreen.get()).intValue(), ((Number) Arraylist.this.textBlue.get()).intValue(), 1), new Color(((Number) Arraylist.this.textRed2.get()).intValue(), ((Number) Arraylist.this.textGreen2.get()).intValue(), ((Number) Arraylist.this.textBlue2.get()).intValue(), 1), Math.abs((double) System.currentTimeMillis() / (double) ((Number) Arraylist.this.fadeSpeed.get()).floatValue() + (double) (module.getHigt() / (float) fontRenderer.getFontHeight())) / (double) 10);
                                    Intrinsics.checkExpressionValueIsNotNull(color, "RenderUtils.getGradientO�?                 ) / 10))");
                                    int l = color.getRGB();

                                    --counter[0];
                                    color = ColorUtils.LiquidSlowly(System.nanoTime(), j * ((Number) Arraylist.this.liquidSlowlyDistanceValue.get()).intValue(), ((Number) Arraylist.this.saturationValue.get()).floatValue(), ((Number) Arraylist.this.brightnessValue.get()).floatValue());
                                    ...
                                    i = StringsKt.equals(colorMode, "Random", true) ? k : (StringsKt.equals(colorMode, "Sky", true) ? Sky : (StringsKt.equals(colorMode, "CRainbow", true) ? CRainbow : (StringsKt.equals(colorMode, "LiquidSlowly", true) ? LiquidSlowly : (StringsKt.equals(colorMode, "Fade", true) ? FadeColor : (StringsKt.equals(colorMode, "Gradinet", true) ? l : customColor)))));
                                    continue;
                                }
                            }

                            i = (new Color(((Number) Arraylist.this.shadowColorRedValue.get()).intValue(), ((Number) Arraylist.this.shadowColorGreenValue.get()).intValue(), ((Number) Arraylist.this.shadowColorBlueValue.get()).intValue())).getRGB();
                        }
                    ...
                    public final void invoke() {
                        if (!((Boolean) Arraylist.this.shadowNoCutValue.get()).booleanValue()) {
                            GL11.glPushMatrix();
                            GL11.glTranslated(Arraylist.this.getRenderX(), Arraylist.this.getRenderY(), 0.0D);
                            Iterable $this$forEachIndexed$iv = (Iterable) Arraylist.this.modules;
                            boolean $i$f$forEachIndexed = false;
                            ...
                            while (iterator.hasNext()) {
                                ...
                                Module module = (Module) item$iv;
                                boolean $i$a$-forEachIndexed-Arraylist$drawElement$2$1 = false;
                                float xPos = -module.getSlide() - (float) 2;

                                RenderUtils.quickDrawRect(xPos - (float) (StringsKt.equals((String) Arraylist.this.rectRightValue.get(), "right", true) ? 3 : 2), module.getArrayY(), StringsKt.equals((String) Arraylist.this.rectRightValue.get(), "right", true) ? -1.0F : 0.0F, module.getArrayY() + textHeight);
                            }
            ...
            if (((Boolean) this.blurValue.get()).booleanValue()) {
                ...
                for (iterator = iterable1.iterator(); iterator.hasNext(); f1 = Math.min(f1, -CRainbow)) {
                    ...
                    index = index$iv++;
                    $i$a$-forEachIndexed-Arraylist$drawElement$10 = false;
                    if (index < 0) {
                        CollectionsKt.throwIndexOverflow();
                    }
                ...
                BlurUtils.blur(f2, f3, f2 + f1, f3 + f, ((Number) this.blurStrength.get()).floatValue(), false, (Function0) (new Function0(0) {
                    public final void invoke() {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            Module module = (Module) item$iv;
                            boolean $i$a$-forEachIndexed-Arraylist$drawElement$4$1 = false;
                            float xPos = -module.getSlide() - (float) 2;

                            RenderUtils.quickDrawRect(f + xPos - (float) (StringsKt.equals((String) Arraylist.this.rectRightValue.get(), "right", true) ? 3 : 2), f1 + module.getArrayY(), f + (StringsKt.equals((String) Arraylist.this.rectRightValue.get(), "right", true) ? -1.0F : 0.0F), f1 + module.getArrayY() + textHeight);
                        }
            ...
            while (true) {
                ...
                color3 = false;
                color = RenderUtils.getGradientOffset(new Color(((Number) this.textRed.get()).intValue(), ((Number) this.textGreen.get()).intValue(), ((Number) this.textBlue.get()).intValue(), 1), new Color(((Number) this.textRed2.get()).intValue(), ((Number) this.textGreen2.get()).intValue(), ((Number) this.textBlue2.get()).intValue(), 1), Math.abs((double) System.currentTimeMillis() / (double) ((Number) this.fadeSpeed.get()).floatValue() + (double) (module.getHigt() / (float) fontRenderer.getFontHeight())) / (double) 10);
                Intrinsics.checkExpressionValueIsNotNull(color, "RenderUtils.getGradientO�?                 ) / 10))");
                k1 = color.getRGB();
                RenderUtils.drawRect(xPos1 - (float) (StringsKt.equals((String) this.rectRightValue.get(), "right", true) ? 3 : 2), module.getArrayY(), StringsKt.equals((String) this.rectRightValue.get(), "right", true) ? -1.0F : 0.0F, module.getArrayY() + textHeight, backgroundCustomColor);
                fontRenderer.drawString(displayString, xPos1 - (float) (StringsKt.equals((String) this.rectRightValue.get(), "right", true) ? 1 : 0), module.getArrayY() + textY, StringsKt.equals(colorMode, "Random", true) ? k : (StringsKt.equals(colorMode, "Sky", true) ? l : (StringsKt.equals(colorMode, "CRainbow", true) ? i1 : (StringsKt.equals(colorMode, "LiquidSlowly", true) ? LiquidSlowly : (StringsKt.equals(colorMode, "Fade", true) ? j1 : (StringsKt.equals(colorMode, "Gradinet", true) ? k1 : customColor))))), textShadow);
                if (!StringsKt.equals((String) this.rectRightValue.get(), "none", true)) {
                    rectColor = StringsKt.equals(rectColorMode, "Random", true) ? k : (StringsKt.equals(rectColorMode, "Sky", true) ? l : (StringsKt.equals(rectColorMode, "CRainbow", true) ? i1 : (StringsKt.equals(rectColorMode, "LiquidSlowly", true) ? LiquidSlowly : (StringsKt.equals(rectColorMode, "Fade", true) ? j1 : (StringsKt.equals(rectColorMode, "Gradinet", true) ? k1 : rectCustomColor)))));
                    if (StringsKt.equals((String) this.rectRightValue.get(), "left", true)) {
                        RenderUtils.drawRect(xPos1 - (float) 3, module.getArrayY(), xPos1 - (float) 2, module.getArrayY() + textHeight, rectColor);
                    } else if (StringsKt.equals((String) this.rectRightValue.get(), "right", true)) {
                        RenderUtils.drawRect(-1.0F, module.getArrayY(), 0.0F, module.getArrayY() + textHeight, rectColor);
                    } else if (StringsKt.equals((String) this.rectRightValue.get(), "outline", true)) {
                        RenderUtils.drawRect(-1.0F, module.getArrayY() - 1.0F, 0.0F, module.getArrayY() + textHeight, rectColor);
                        RenderUtils.drawRect(xPos1 - (float) 3, module.getArrayY(), xPos1 - (float) 2, module.getArrayY() + textHeight, rectColor);
                        if (Intrinsics.areEqual(module, (Module) this.modules.get(0)) ^ true) {
                            ...
                            RenderUtils.drawRect(xPos1 - (float) 3 - (float) (fontRenderer.getStringWidth(displayStrings) - fontRenderer.getStringWidth(displayString)), module.getArrayY(), xPos1 - (float) 2, module.getArrayY() + (float) 1, rectColor);
                            if (Intrinsics.areEqual(module, (Module) this.modules.get(this.modules.size() - 1))) {
                                RenderUtils.drawRect(xPos1 - (float) 3, module.getArrayY() + textHeight, 0.0F, module.getArrayY() + textHeight + (float) 1, rectColor);
                            }
                        } else {
                            RenderUtils.drawRect(xPos1 - (float) 3, module.getArrayY(), 0.0F, module.getArrayY() - (float) 1, rectColor);
                        }
                        ...
                        if (Intrinsics.areEqual(module, (Module) this.modules.get(0))) {
                            RenderUtils.drawRect(xPos1 - (float) 2, module.getArrayY(), 0.0F, module.getArrayY() - (float) 1, rectColor);
                        }

                        if (Intrinsics.areEqual(module, (Module) this.modules.get(this.modules.size() - 1))) {
                            RenderUtils.drawRect(xPos1 - (float) 2, module.getArrayY() + textHeight, 0.0F, module.getArrayY() + textHeight + (float) 1, rectColor);
                        }
        ...
        case 3:
                ...
                ShadowUtils.INSTANCE.shadow((float) ((Number) this.shadowStrength.get()).intValue(), (Function0) (new Function0(0) {
                    public final void invoke() {
                        ...
                        for (Iterator iterator = $this$forEachIndexed$iv.iterator(); iterator.hasNext(); RenderUtils.drawRect(f3, f2, f1, f, i)) {
                            ...
                            Module module = (Module) item$iv;
                            boolean $i$a$-forEachIndexed-Arraylist$drawElement$6$1 = false;
                            String displayString = Arraylist.this.getModName(module);
                            int width = fontRenderer.getStringWidth(displayString);
                            float xPos = -((float) width - module.getSlide()) + (float) (StringsKt.equals((String) Arraylist.this.rectLeftValue.get(), "left", true) ? 3 : 2);
                            float f4 = module.getArrayY();
                            float f5 = xPos + (float) width + (StringsKt.equals((String) Arraylist.this.rectLeftValue.get(), "right", true) ? 3.0F : 2.0F);
                            float f6 = module.getArrayY() + textHeight;
                            String s = (String) Arraylist.this.shadowColorMode.get();
                    ...
                    public final void invoke() {
                        if (!((Boolean) Arraylist.this.shadowNoCutValue.get()).booleanValue()) {
                            ...
                            while (iterator.hasNext()) {
                                ...
                                Module module = (Module) item$iv;
                                boolean $i$a$-forEachIndexed-Arraylist$drawElement$7$1 = false;
                                String displayString = Arraylist.this.getModName(module);
                                int width = fontRenderer.getStringWidth(displayString);
                                float xPos = -((float) width - module.getSlide()) + (float) (StringsKt.equals((String) Arraylist.this.rectLeftValue.get(), "left", true) ? 3 : 2);

                                RenderUtils.quickDrawRect(0.0F, module.getArrayY(), xPos + (float) width + (float) (StringsKt.equals((String) Arraylist.this.rectLeftValue.get(), "right", true) ? 3 : 2), module.getArrayY() + textHeight);
                            }
                ...
                BlurUtils.blur(f2, f3, f2 + f1, f3 + f, ((Number) this.blurStrength.get()).floatValue(), false, (Function0) (new Function0(0) {
                    public final void invoke() {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            Module module = (Module) item$iv;
                            boolean $i$a$-forEachIndexed-Arraylist$drawElement$9$1 = false;
                            String displayString = Arraylist.this.getModName(module);
                            int width = fontRenderer.getStringWidth(displayString);
                            float xPos = -((float) width - module.getSlide()) + (float) (StringsKt.equals((String) Arraylist.this.rectLeftValue.get(), "left", true) ? 3 : 2);

                            RenderUtils.quickDrawRect(f, f1 + module.getArrayY(), f + xPos + (float) width + (float) (StringsKt.equals((String) Arraylist.this.rectLeftValue.get(), "right", true) ? 3 : 2), f1 + module.getArrayY() + textHeight);
                        }
            ...
            while (iterator1.hasNext()) {
                ...
                $i$a$-forEachIndexed-Arraylist$drawElement$10 = false;
                displayString = this.getModName(module);
                int l1 = fontRenderer.getStringWidth(displayString);

                xPos1 = -((float) l1 - module.getSlide()) + (float) (StringsKt.equals((String) this.rectLeftValue.get(), "left", true) ? 3 : 2);
                color = Color.getHSBColor(module.getHue(), saturation, brightness);
                Intrinsics.checkExpressionValueIsNotNull(color, "Color.getHSBColor(module�?, saturation, brightness)");
                k = color.getRGB();
                flag2 = false;
                ...
                Intrinsics.checkExpressionValueIsNotNull(color, "RenderUtils.getGradientO�?                 ) / 10))");
                k1 = color.getRGB();
                RenderUtils.drawRect(0.0F, module.getArrayY(), xPos1 + (float) l1 + (float) (StringsKt.equals((String) this.rectLeftValue.get(), "right", true) ? 3 : 2), module.getArrayY() + textHeight, backgroundCustomColor);
                fontRenderer.drawString(displayString, xPos1, module.getArrayY() + textY, StringsKt.equals(colorMode, "Random", true) ? k : (StringsKt.equals(colorMode, "Sky", true) ? l : (StringsKt.equals(colorMode, "CRainbow", true) ? i1 : (StringsKt.equals(colorMode, "LiquidSlowly", true) ? LiquidSlowly : (StringsKt.equals(colorMode, "Fade", true) ? j1 : (StringsKt.equals(colorMode, "Gradinet", true) ? k1 : customColor))))), textShadow);
                if (!StringsKt.equals((String) this.rectLeftValue.get(), "none", true)) {
                    rectColor = StringsKt.equals(rectColorMode, "Random", true) ? k : (StringsKt.equals(rectColorMode, "Sky", true) ? l : (StringsKt.equals(rectColorMode, "CRainbow", true) ? i1 : (StringsKt.equals(rectColorMode, "LiquidSlowly", true) ? LiquidSlowly : (StringsKt.equals(rectColorMode, "Fade", true) ? j1 : (StringsKt.equals(rectColorMode, "Gradinet", true) ? k1 : rectCustomColor)))));
                    if (StringsKt.equals((String) this.rectLeftValue.get(), "left", true)) {
                        RenderUtils.drawRect(0.0F, module.getArrayY() - (float) 1, 1.0F, module.getArrayY() + textHeight, rectColor);
                    } else if (StringsKt.equals((String) this.rectLeftValue.get(), "right", true)) {
                        RenderUtils.drawRect(xPos1 + (float) l1 + (float) 2, module.getArrayY(), xPos1 + (float) l1 + (float) 2 + (float) 1, module.getArrayY() + textHeight, rectColor);
                    }
                }
            }
        }
    ...
    public void updateElement() {
        ...
        Module it;
        boolean $i$a$-filter-Arraylist$updateElement$2;
        List list;
        ...
        if (((Boolean) this.abcOrder.get()).booleanValue()) {
            ...
            while (iterator.hasNext()) {
                ...
                $i$a$-filter-Arraylist$updateElement$2 = false;
            ...
            $i$f$filterTo1 = (Comparator) (new Arraylist$updateElement$$inlined$sortedBy$1(this));
            list = CollectionsKt.sortedWith($this$sortedBy$iv, $i$f$filterTo1);
            arraylist = this;
            list1 = list;
        }

        arraylist.modules = list1;
        arraylist = this;
        if (((Boolean) this.abcOrder.get()).booleanValue()) {
            ...
            $i$f$sortedBy = false;
            destination$iv$iv1 = false;
            $i$f$filterTo1 = (Comparator) (new Arraylist$updateElement$$inlined$sortedBy$2(this));
            list = CollectionsKt.sortedWith($this$sortedBy$iv, $i$f$filterTo1);
            arraylist = this;
            list1 = CollectionsKt.toList((Iterable) list);
        }

        arraylist.sortedModules = list1;
    }
    ...
    public final String getModName(@NotNull Module mod) {
        ...
        String displayName = mod.getName() + this.getModTag(mod);
    ...
    public Arraylist(double x, double y, float scale, @NotNull Side side) {
        ...
        this.shadowColorMode = new ListValue("Shadow-Color", new String[] { "Background", "Text", "Custom"}, "Text");
        ...
        this.fadeSpeed = new FloatValue("Gradinet-Speed", 800.0F, 100.0F, 1000.0F);
        ...
        IFontRenderer ifontrenderer = Fonts.tenacity35;

        Intrinsics.checkExpressionValueIsNotNull(Fonts.tenacity35, "Fonts.tenacity35");
    ...
    public Arraylist(double d0, double d1, float f, Side side, int i, DefaultConstructorMarker defaultconstructormarker) {
        if ((i & 1) != 0) {
            d0 = 1.0D;
        }
    ...
    public static final void access$setModules$p(Arraylist $this, List <set-?>) {
        $this.modules = <set-?>;
    }

    public static final FontValue access$getFontValue$p(Arraylist $this) {
