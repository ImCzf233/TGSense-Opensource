...
@Metadata(
    ...
    k = 3,
    d1 = { "\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002¨\u0006\u0003"},
    d2 = { "<anonymous>", "", "invoke", "net/ccbluex/liquidbounce/ui/client/hud/element/elements/ScoreboardElement$drawElement$1$1"}
)
final class ScoreboardElement$drawElement$$inlined$forEachIndexed$lambda$1 extends Lambda implements Function0 {
    ...
    ScoreboardElement$drawElement$$inlined$forEachIndexed$lambda$1(ScoreboardElement scoreboardelement, IScoreboard iscoreboard, int i, IFontRenderer ifontrenderer, int j, int k, ObjectRef objectref, IScoreObjective iscoreobjective, IntRef intref, String s, int l) {
        super(0);
