...
public class TTFFontRenderer {
    ...
    private TTFFontRenderer.CharacterData[] setup(TTFFontRenderer.CharacterData[] characterData, int type) {
        ...
        for (int index = 0; index < characterData.length; ++index) {
            ...
            BufferedImage characterImage = new BufferedImage(MathHelper.ceil(width), MathHelper.ceil(height), 2);
                ...
                if (previous != 167) {
                    if (character == 167 && i < length) {
                        ...
                        if (i < 16) {
                            ...
                            int textColor = this.colorCodes[i];
                        ...
                        if (obfuscated) {
                            character = (char) (character + TTFFontRenderer.RANDOM_OFFSET);
                        }
