...
public class CustomTextField {
    ...
    public void draw(float x, float y) {
        ...
        RenderUtils.drawRoundedRect(this.x, this.y + 3.0F, this.x + 115.0F, this.y + 15.0F, 1.0F, -13355204);
        GL11.glPushMatrix();
        GL11.glScissor((int) this.x + 1, (int) this.y + 3, 113, 11);
        Fonts.com18.drawString(this.textString, this.x + 1.5F - this.offset, this.y + 4.0F, Color.GRAY.getRGB());
        if (this.isFocused) {
            float width = (float) (Fonts.com18.getStringWidth(this.textString.substring(0, selectedChar)) + 4);
    ...
    public void keyPressed(int key) {
        ...
        if (this.isFocused) {
            ...
            case 14:
                try {
                    if (this.selectedChar > 0 && this.textString.length() != 0) {
                        ...
                        --this.selectedChar;
                        if ((float) (Fonts.com18.getStringWidth(this.oldString) + 2) > 111.0F && this.offset > 0.0F) {
                            this.newTextWidth = (float) (Fonts.com18.getStringWidth(this.textString) + 2);
                            this.oldTextWidth = (float) (Fonts.com18.getStringWidth(this.oldString) + 2);
            ...
            case 203:
                ...
                width = (float) (Fonts.com18.getStringWidth(this.textString.substring(0, this.selectedChar)) + 2);
    ...
    public void charTyped(char c) {
        if (this.isFocused && ChatAllowedCharacters.isAllowedCharacter(c)) {
            ...
            if (this.selectedChar > this.textString.length()) {
                ...
                ++this.selectedChar;
                float width = (float) (Fonts.com18.getStringWidth(this.textString.substring(0, this.selectedChar)) + 2);
