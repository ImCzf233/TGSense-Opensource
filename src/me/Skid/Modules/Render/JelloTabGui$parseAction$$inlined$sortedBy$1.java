...
public final class JelloTabGui$parseAction$$inlined$sortedBy$1 implements Comparator {

    public final int compare(Object a, Object b) {
        boolean flag = false;
        Module it = (Module) a;
        boolean $i$a$-sortedBy-JelloTabGui$parseAction$2 = false;
        Comparable comparable = (Comparable) Integer.valueOf(0);

        it = (Module) b;
        Comparable comparable1 = comparable;

        $i$a$-sortedBy-JelloTabGui$parseAction$2 = false;
