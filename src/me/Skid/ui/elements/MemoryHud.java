...
public class MemoryHud extends Element {
    ...
    public Border drawElement() {
        double ramPercentage = (double) (Memory.usedMemorySize / Memory.maxMemorySize);

        ramPercentage = MathHelper.clamp(ramPercentage, 0.0D, 1.0D);
        double newWidth = 51.0D * ramPercentage;
        ...
        Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.drawCenteredString("RAM", (float) (this.x + 20), (float) (this.y + 14 - 10), -1);
        ...
        double scoef1 = (double) (Memory.usedMemorySize / Memory.maxMemorySize * 100.0F);
