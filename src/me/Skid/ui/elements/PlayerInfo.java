...
public class PlayerInfo extends Element {
    ...
    public Border drawElement() {
        float armorValue = (float) PlayerInfo.mc2.player.getTotalArmorValue();
        double armorPercentage = (double) (armorValue / 20.0F);

        armorPercentage = MathHelper.clamp(armorPercentage, 0.0D, 1.0D);
        double newWidth = 51.0D * armorPercentage;

        this.animWidth = (float) AnimationHelper.animate(newWidth, (double) this.animWidth, 0.0229999852180481D);
        RenderUtils.drawSmoothRect((double) this.x, (double) this.y, (double) ((float) this.x + 140.0F), (double) ((float) this.y + 70.0F), (new Color(0, 0, 0, 100)).getRGB());
        ...
        Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.drawCenteredString("Armor", (float) (this.x + 20), (float) (this.y + 14 - 10), -1);
        ...
        double scoef1 = (double) ((float) PlayerInfo.mc2.player.getTotalArmorValue() / 20.0F * 100.0F);
        ...
        Fonts.SFBOLD.SFBOLD_15.SFBOLD_15.drawCenteredString(Math.round(scoef1) + "%", (float) (this.x + 20), (float) (this.y + 22), -1);
        if (((Boolean) this.BlurValue.get()).booleanValue()) {
            GL11.glTranslated(-this.renderX.doubleValue(), -this.renderY.doubleValue(), 0.0D);
            GL11.glPushMatrix();
            BlurUtils.blurArea((float) this.x, (float) this.y, (float) this.x + 40.0F, (float) this.y + 43.0F, ((Float) this.blurStrength.get()).floatValue());
            GL11.glPopMatrix();
            GL11.glTranslated(this.renderX.doubleValue(), this.renderY.doubleValue(), 0.0D);
        }
