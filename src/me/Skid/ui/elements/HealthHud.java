...
public class HealthHud extends Element {
    ...
    public Border drawElement() {
        float health = HealthHud.mc2.player.getHealth();
        double hpPercentage = (double) (health / HealthHud.mc2.player.getMaxHealth());

        hpPercentage = MathHelper.clamp(hpPercentage, 0.0D, 1.0D);
        double newWidth = 51.0D * hpPercentage;
        ...
        Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.drawCenteredString("HP", (float) (this.x + 20), (float) (this.y + 14 - 10), -1);
        ...
        double scoef1 = (double) (HealthHud.mc2.player.getHealth() / HealthHud.mc2.player.getMaxHealth() * 100.0F);
